        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    AddedBy_Id = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ClinicId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_AddedBy_Id",
                        column: x => x.AddedBy_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diagnoses_MedicalExaminations_ExaminationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabTests_MedicalExaminations_ExaminationId",
                        column: x => x.ExaminationId,
                        principalTable: "MedicalExaminations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalScans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalScans_MedicalExaminations_ExaminationId",
                        column: x => x.ExaminationId,
                        principalTable: "MedicalExaminations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_MedicalExaminations_ExaminationId",
                        column: x => x.ExaminationId,
                        principalTable: "MedicalExaminations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Procedures_MedicalExaminations_ExaminationId",
                        column: x => x.ExaminationId,
                        principalTable: "MedicalExaminations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "5", null, "hygienist", "HYGIENIST" },
                    { "6", null, "user", "USER" }
                });

            migrationBuilder.InsertData(
                table: "Clinics",
                columns: new[] { "Id", "City", "ClinicEmail", "ClinicPhone", "Country", "Name", "OwnerId", "PostalCode", "State", "WorkingDate" },
                values: new object[] { 1, "Mansoura", "DentalCare.Customers@gmail.com", "01019292839", "Egypt", "DentalCare", null, "37111", "Gamaa", "today 24 hours" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AddedBy_Id",
                table: "Appointments",
                column: "AddedBy_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LabTests_ExaminationId",
                table: "LabTests",
                column: "ExaminationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalScans_ExaminationId",
                table: "MedicalScans",
                column: "ExaminationId");
