            ...
            try
            {
                var query = from patient in _db.Patients
                            ...
                            select new PatientResponse()
                            {
                                ...
                                Allergies = allgric != null? allgric.Name.Split(',', StringSplitOptions.RemoveEmptyEntries): null,
        ...
        public async Task<IEnumerable<PatientResponse>> GetClinicPatients(int clinicId)
        {
            var query = from patient in _db.Patients
                        ...
                        select new PatientResponse
                        {
                            ...
                            Allergies = allergic.Name.Split(',', StringSplitOptions.RemoveEmptyEntries),
